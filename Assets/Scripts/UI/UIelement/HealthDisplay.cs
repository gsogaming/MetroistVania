...
public class HealthDisplay : UIelement
{
    ...
    public override void UpdateUI()
    {
        if (GameManager.instance != null && GameManager.instance.player != null)
        {
            ...
            {
                //SetChildImageNumber(playerHealth.currentHealth); >> original code
                SetHealthBar(playerHealth.currentHealth, playerHealth.maximumHealth);
            }
        }
    ...
    private void SetHealthBar(int currentHealth,int maximumHealth)
    {
                   
            playerHealthSlider.value = (float)currentHealth/maximumHealth;
